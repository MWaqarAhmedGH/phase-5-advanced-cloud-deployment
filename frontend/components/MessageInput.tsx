...
const MessageInput = forwardRef<MessageInputHandle, MessageInputProps>(function MessageInput({
  onSendMessage,
  disabled = false,
  placeholder = "Type a message... (e.g., 'Add a high priority task tagged work')",
}, ref) {
  ...
  return (
    <div className="flex-shrink-0 glass border-t border-white/8 p-4">
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="group relative px-5 py-3 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-medium shadow-glow-emerald transition-all duration-300 hover:shadow-glow-blue hover:scale-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 disabled:hover:shadow-none"
        >
          {disabled ? (
