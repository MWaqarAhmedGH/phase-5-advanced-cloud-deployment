...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative py-12">
      ...
      <div className="orb orb-emerald w-96 h-96 -top-24 -right-20" style={{ animationDelay: "0s" }}></div>
      <div className="orb orb-blue w-80 h-80 bottom-1/3 -left-16" style={{ animationDelay: "2.5s" }}></div>
      <div className="orb orb-amber w-64 h-64 -bottom-10 right-1/3" style={{ animationDelay: "4.5s" }}></div>
        ...
        <div className="perspective-container">
          <div className="glass-card rounded-2xl p-8 card-3d">
            ...
            <div className="text-center mb-8">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-emerald-500 mb-4 shadow-glow-blue">
                <svg
            ...
            <form onSubmit={handleSignUp} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full btn-neon py-3.5 rounded-xl text-base disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none mt-2"
              >
                {isLoading ? (
